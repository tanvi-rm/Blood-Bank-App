...
import com.example.lifeshare.databinding.ActivityPaytmPageBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.ktx.firestore
import com.google.firebase.ktx.Firebase

class paytm_page : AppCompatActivity() {
    private lateinit var binding: ActivityPaytmPageBinding
    private lateinit var firebaseAuth: FirebaseAuth
    private var db= Firebase.firestore

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPaytmPageBinding.inflate(layoutInflater)
        ...
        binding.pytmpy.setOnClickListener {
