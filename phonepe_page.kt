...
import com.example.lifeshare.databinding.ActivityPhonepePageBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.ktx.firestore
import com.google.firebase.ktx.Firebase

class phonepe_page : AppCompatActivity() {
    private lateinit var binding: ActivityPhonepePageBinding
    private lateinit var firebaseAuth: FirebaseAuth
    private var db= Firebase.firestore

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPhonepePageBinding.inflate(layoutInflater)
        ...
        binding.phnepay.setOnClickListener {
